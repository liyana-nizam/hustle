        ...
        <nav>
            <?php if ($role == 'admin') { ?>
                <ul class="hLeft-container">
                    <li><a href="progress.php" class="<?php if ($currentPage == 'progress.php') echo "current"; ?>">Gig Progress</a></li>
                ...
                <ul class="hRight-container">
                    ...
                    <li><a href="profile.php" class="<?php if ($currentPage == 'profile.php') echo "current"; ?>">Admin</a></li>
            ...
            <?php } elseif ($role == 'gig worker') { ?>
                ...
                <ul class="hRight-container">
                    <li><a href="noti.php"><img src="images/notification.png" alt="Notification"></a></li>
                    <li><a href="profile.php" class="<?php if ($currentPage == 'profile.php') echo "current"; ?>">Gig Worker</a></li>
                    <li><a href="logout.php">Log Out</a></li>
                </ul>
            <?php } elseif ($role == 'gig owner') { ?>
                ...
                <ul class="hRight-container">
                    <li><a href="noti.php"><img src="images/notification.png" alt="Notification"></a></li>
                    <li><a href="profile.php" class="<?php if ($currentPage == 'profile.php') echo "current"; ?>">Gig Owner</a></li>
                    <li><a href="logout.php">Log Out</a></li>
                </ul>
            <?php } ?>
        </nav>
